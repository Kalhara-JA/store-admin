...
export async function GET(
    ...
    try {
        ...
        const billboard = await prsimadb.billboard.findUnique({
            where: {
...
export async function PATCH(
    ...
    try {
        ...
        const billboard = await prsimadb.billboard.updateMany({
            where: {
                id: params.billboardId,
            },
            data: {
...
export async function DELETE(
    ...
    try {
        ...
        const billboard = await prsimadb.billboard.deleteMany({
            where: {
                id: params.billboardId,
            }
        });
